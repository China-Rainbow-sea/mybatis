...
public class TestCarMapper {
    ...
    public void testSelectByChoose() throws IOException {
        ...
        // 第一条件为空
        //List<Car> cars = mapper.selectByChoose("",3.00,"燃油车");
        // 两个条件为Null
...
比如我们只更新提交的不为空的字段，如果提交的数据是空或者""，那么这个字段我们将不更新。*/
    ...
    public void testUpdateSet() throws IOException {
        ...
        SqlSession sqlSession = sqlSessionFactory.openSession();
        CarMapper mapper = sqlSession.getMapper(CarMapper.class);
        Car car = new Car(131L, null, "丰田霸道", null, null, "燃油车");
    ...
    public void testUpdateById() throws IOException {
        ...
        SqlSession sqlSession = sqlSessionFactory.openSession();
        CarMapper mapper = sqlSession.getMapper(CarMapper.class);
        Car car = new Car(130L, null, "丰田霸道", null, null, "燃油车");
    ...
    public void testSelectByMultiConditionWithTrim() throws IOException {
        ...
        //List<Car> cars = mapper.selectByMultiConditionWithTrim("小米",null,"");
    ...
    public void testSelectByMultiConditionWithWhere() throws IOException {
        ...
        // 如果第一个条件是空，其他的不为空
        //List<Car> cars = mapper.selectByMultiConditionWithWhere("",21.00,"新能源");


        // 假设第一个条件不是空，后两个条件为空
        List<Car> cars = mapper.selectByMultiConditionWithWhere("小米",null,"");
